...
permalink: /pourquoi-bordeaux-est-plus-cher-que-nantes-et-toulouse/
sources:
  - sources/ladepeche-bordeaux-tgv-2017.md
  - sources/meilleurs-agents-bordeaux-2017.md
  - sources/lesechos-bordeaux-lgv-2017.md
  - sources/lesechos-nantes-lgv-2017.md
  - sources/ladepeche-castex-lgv-toulouse-2022.md
  - sources/ladepeche-toulouse-3e-ville-2026.md
  - sources/nexity-prix-metropoles-2013-2023.md
  - sources/permisapi-bordeaux-33063.md
  - sources/permisapi-nantes-44109.md
  - sources/permisapi-toulouse-31555.md
  - sources/bordeaux-euratlantique-oin.md
...
- **Toulouse** est devenue la **3e commune de France** (~515 000 hab.), portée par l'aéronautique et la croissance démographique la plus forte du pays [La Dépêche Tls](sources/ladepeche-toulouse-3e-ville-2026.md) ?
...
- **Bordeaux** : +15 % en 2016 (anticipation), puis +12 à +17 % en 2017 → ~3 600 €/m². Frénésie d'achat, pénurie [Les Echos Bdx](sources/lesechos-bordeaux-lgv-2017.md) [La Dépêche Bdx](sources/ladepeche-bordeaux-tgv-2017.md).
- **Nantes** : +4 % appartements, +12 % maisons sur 2016-17 ; marché « encore fourni » [Les Echos Nte](sources/lesechos-nantes-lgv-2017.md). Sur 10 ans : +56 % vs **+69 %** à Bordeaux [Nexity](sources/nexity-prix-metropoles-2013-2023.md).
...
Toulouse suit une **trajectoire différente** : pas de choc LGV en 2017, mais une croissance organique portée par **Airbus, l'aéronautique, l'université** (+1,2 %/an, championne de France [La Dépêche Tls](sources/ladepeche-toulouse-3e-ville-2026.md)).

**14 mars 2022** : Jean Castex signe le financement de la **LGV Bordeaux–Toulouse** — travaux 2024, service **2032** (Toulouse–Paris ~3 h, Bordeaux–Toulouse ~1 h) [Castex 2022](sources/ladepeche-castex-lgv-toulouse-2022.md).
...
**Plus d'habitants, plus d'industrie — mais prix +31 % sur 10 ans vs +69 % à Bordeaux** [Nexity](sources/nexity-prix-metropoles-2013-2023.md).
...
2. **Pénurie structurelle** — « il n'y a plus de bonnes affaires », pénurie de biens à la vente [Les Echos Bdx](sources/lesechos-bordeaux-lgv-2017.md).
3. **Report de prix parisiens** — vendre à Paris, acheter à Bordeaux : pouvoir d'achat relatif qui fait monter les enchères au-delà des salaires locaux ; gentrification constatée par les notaires [La Dépêche Bdx](sources/ladepeche-bordeaux-tgv-2017.md). **Spéculation & investisseurs** (35 % des acquisitions, rendements bas acceptés) amplifie le mouvement [MA 2017](sources/meilleurs-agents-bordeaux-2017.md).
4. **Euratlantique** — OIN créée pour la LGV, logements orientés haut de gamme [OIN](sources/bordeaux-euratlantique-oin.md).
...
- [La Dépêche — Bordeaux et le TGV (2017)](sources/ladepeche-bordeaux-tgv-2017.md)
- [Les Echos — flambée bordelaise (2017)](sources/lesechos-bordeaux-lgv-2017.md)
- [Les Echos — marché nantais (2017)](sources/lesechos-nantes-lgv-2017.md)
- [Meilleurs Agents — baromètre Bordeaux (2017)](sources/meilleurs-agents-bordeaux-2017.md)
- [La Dépêche — Castex et LGV Bordeaux–Toulouse (2022)](sources/ladepeche-castex-lgv-toulouse-2022.md)
- [La Dépêche — Toulouse 3e ville (2026)](sources/ladepeche-toulouse-3e-ville-2026.md)

### Données et documents officiels

- [Nexity — prix métropoles 2013–2023](sources/nexity-prix-metropoles-2013-2023.md)
- [Permis de construire Bordeaux (Sitadel)](sources/permisapi-bordeaux-33063.md)
- [Permis de construire Nantes (Sitadel)](sources/permisapi-nantes-44109.md)
- [Permis de construire Toulouse (Sitadel)](sources/permisapi-toulouse-31555.md)
- [OIN Bordeaux Euratlantique](sources/bordeaux-euratlantique-oin.md)
